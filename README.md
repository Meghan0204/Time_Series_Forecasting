...
A Time Series Forecasting project completed as part of the **Pandas for Time Series Data Analysis** certification coursework on Udemy. This project demonstrates the use of Python libraries to analyze, visualize, and forecast time-based data.
...
- Generate forecasts to predict future data points  
...
2. **Exploratory Data Analysis (EDA)**  
   - Visualized trends, seasonality, and anomalies using matplotlib  
